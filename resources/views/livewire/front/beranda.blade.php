<div>
    ...
    <!-- modal -->
    @include('components.front.index.hero-section')
    @include('components.front.index.data_diri')
    @include('components.front.index.data-company')
    @include('components.front.index.unggulan')
    @include('components.front.index.konsultasi')
    @include('components.front.index.paket')
    @include('components.front.index.harga-paket')
</div>
