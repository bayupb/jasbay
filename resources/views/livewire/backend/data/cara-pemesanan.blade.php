<div>
    <div class="w-full flex flex-col max-w-6xl container mx-auto my-10">
        ...
        <div class="my-2">
            ...
            @if($modalOpen)
            @include('livewire.backend.data.modal.modal')
            @endif
        </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="py-4 px-6 text-sm font-medium text-gray-500">
                                        {{$item['deskripsi_cara']}}</td>
                                    <td class="py-4 px-6 text-sm font-medium ">
                                        @if($item['status'] == 0)
                                        <span class="bg-blue-500 py-2 rounded-md px-5 text-white">Aktif</span>
                                        @else
                                        <span class="bg-red-600 py-2 rounded-md px-5 text-white">Tidak</span>
