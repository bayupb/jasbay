<div>
    <div class="w-full flex flex-col max-w-6xl container mx-auto my-10">
        ...
        <div class="my-2">
            ...
            @if($modalOpen)
            @include('livewire.backend.data.modal.keunggulan_modal')
            @endif
        </div>
                        ...
                        <table class=" w-full divide-y divide-gray-200 table-fixed text-center ">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="py-4 px-6 text-sm font-medium text-gray-900">
                                        @if($item['gambar_keunggulan'])
                                            <img src="{{asset($item['gambar_keunggulan'])}}" class="w-24 h-24">
                                        @else
                                            <img src="https://ui-avatars.com/api/?name={{$item['nama_keunggulan']}}" class="w-24 h-24">
                                        @endif
                                    </td>

                                    <td class="py-4 px-6 text-sm font-medium text-gray-900">
                                        {{$item['nama_keunggulan']}}</td>
                                    <td class="py-4 px-6 text-sm font-medium text-gray-500">
                                        {{$item['deskripsi_keunggulan']}}</td>
