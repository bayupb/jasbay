<div>
    <div class="w-full flex flex-col max-w-6xl container mx-auto my-10">
        ...
        <div class="my-2">
            ...
            <button wire:click="openModal()" type="button"  data-modal-toggle="large-modal"
            ...
            @if($modalOpen)
            @include('livewire.backend.data.modal.harga_paket')
            @endif
        </div>
                        ...
                        <table class=" w-full divide-y divide-gray-200 table-fixed text-center ">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="py-4 px-6 text-sm font-medium text-gray-900">
                                        {{$item['judul_jasa_paket']}}</td>
                                    <td class="py-4 px-6 text-sm font-medium text-gray-900">
                                        {{$item['harga_jasa_paket']}}</td>
