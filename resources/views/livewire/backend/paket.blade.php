<div>
    <div class="w-full flex flex-col max-w-6xl container mx-auto my-10">
        ...
        <div class="my-2">
            ...
            @if($modalOpen)
            @include('livewire.backend.data.modal.paket_modal')
            @endif
        </div>
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="py-4 px-6 text-sm font-medium text-gray-900">
                                        @if($item['gambar_paket'])
                                            <img src="{{$item['gambar_paket']}}" class="w-24 h-24">
                                        @else
                                            <img src="https://ui-avatars.com/api/?name={{$item['nama_paket']}}" class="w-24 h-24">
                                        @endif
                                    </td>
